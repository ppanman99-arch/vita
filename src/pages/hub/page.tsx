...
export default function Hub() {
  ...
  const adminPages = [
    ...
    { name: "Quản lý Thành viên", path: "/admin-members", icon: "ri-team-line", color: "bg-teal-600" },
    ...
    { name: "Hợp đồng", path: "/admin-contracts", icon: "ri-file-contract-line", color: "bg-purple-700" },
