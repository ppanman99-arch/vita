...
export default function SupplyTopBar() {
  const navigate = useNavigate();
  const [showMenu, setShowMenu] = useState(false);
  
  // Get name from multiple sources
  const coopName = sessionStorage.getItem('supply_coop_name') || 
  ...
  const fromFarmer = sessionStorage.getItem('farmer_authenticated');
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg font-bold text-gray-900">VITA Supply</h1>
              <p className="text-xs text-gray-500">Sàn Cung Ứng Vật Tư</p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              <BackButton className="bg-orange-50 text-orange-600 border-orange-200 hover:bg-orange-100" />
