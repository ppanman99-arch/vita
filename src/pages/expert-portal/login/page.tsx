    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-900 via-rose-900 to-purple-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Đăng nhập tài khoản Chuyên gia</p>
        </div>
          ...
          <div className="mb-5 bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p>Hồ sơ của bạn đang được Ban Cố vấn Khoa học xem xét. Bạn sẽ nhận được email khi có kết quả thẩm định (thường trong 3-5 ngày làm việc).</p>
                <button
        ...
        <form onSubmit={handleLogin}>
          <div className="mb-5">
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-xl mb-4"
          >
          ...
          <button 
            type="button"
            className="w-full text-sm text-gray-600 hover:text-pink-600 transition-colors cursor-pointer mb-6"
          >
            Quên mật khẩu?
          </button>
        </form>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 text-center">
          ...
          <button
            ...
            className="w-full px-6 py-3 bg-white border-2 border-pink-600 text-pink-600 font-semibold rounded-lg hover:bg-pink-50 transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="text-center text-xs text-gray-500 pt-4 border-t mt-6">
          <p>
            ...
            Cần hỗ trợ? Liên hệ: <span className="text-pink-600 font-medium">support@vita.vn</span>
          </p>
        </div>
      </div>
    </div>
